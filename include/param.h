...
const std::map<int, std::vector<oc::u64>> prefixLenMapLow = {
    { 16, { 0, 2 } }, { 32, { 0, 2 } }, { 64, { 0, 3 } }, { 128, { 0, 3 } }, { 256, { 0, 4 } }, { 512, { 0, 4 } }, { 1024, { 0, 5 } }, { 2048, { 0, 4, 8 } },
};

const std::map<int, oc::u64> prefixNumMapLow = {
    { 16, 8 }, { 32, 12 }, { 64, 16 }, { 128, 24 }, { 256, 32 }, { 512, 48 }, { 1024, 64 }, { 2048, 39 },
};
